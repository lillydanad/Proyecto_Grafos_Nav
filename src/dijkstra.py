...
def main():
    ...
    # Convertir todos los nodos a una lista
    lista_nodos = list(G.nodes())

    # Elegir dos nodos cualesquiera
    nodo_inicio = lista_nodos[0]      # El primero de la lista (ej. '286650462')
    nodo_destino = lista_nodos[500]   # El nodo en la posición 500
